...
(function ($) {
    ...
    function content_slider(element, options) {
        ...
        if (this.options.hv_switch)this.last_mouse_x = this.options.y_offset; else this.last_mouse_x = 0;
        ...
        if (this.options.hide_arrows == 0) {
            ...
            if (this.options.border_on_off == 0 || this.options.use_thin_arrows == 1) {
                if (this.options.hv_switch == 0) {
                    this.$left_arrow.css({"z-index": "1000", "margin-top": "15px"});
                    this.$right_arrow.css({"z-index": "1000", "margin-top": "15px"})
                } else {
                    this.$left_arrow.css({"z-index": "1000", "margin-left": "15px"});
                    this.$right_arrow.css({"z-index": "1000", "margin-left": "15px"})
                }
            }
        ...
        if (this.options.max_shown_items > 1 && this.options.hv_switch == 0) {
            if (this.options.border_on_off == 1)$(this.options.text_object, this.$element).css("width", this.max_width - 16 + "px"); else $(this.options.text_object, this.$element).css("width", this.max_width - 22 + "px")
        }
        $(window).resize($.proxy(this._resize, this));
        this._resize();
        var ofst = this.$container.offset();
        if (this.options.hv_switch)this.offset = ofst.top; else this.offset = ofst.left + this.minus;
        if (this.options.hv_switch)this._set_text_div_width_ver(); else this._set_text_div_width_hor();
        ...
        if (this.options.enable_mousewheel == 1) {
            this.$container.bind("mousewheel", function (e, t, n, r) {
                e.preventDefault();
                if (t == -1)self.public_go_left(); else self.public_go_right()
            })
        }
    ...
    content_slider_child.prototype = {
        $: function (e) {
            ...
            if (!o) {
                if (this.options.border_radius == -1)a = r; else {
                ...
                if (this.parent_this.options.hv_switch) {
                    ...
                    if (this.parent_this.have_text_label_down) {
                        ...
                        this.$lower_text.css({top: e, left: n + i + c + h, width: this.parent_this.default_circle_top})
                    }
                ...
                this.$image.css({width: r, height: i, "border-radius": a})
            } else {
                if (this.options.border_radius == -1)a = this.parent_this.options.big_pic_width; else {
                    if (this.options.radius_proportion) {
                        var p = this.options.big_pic_width / this.options.border_radius;
                        var d = r / p;
                        a = d
                ...
                if (this.options.activate_border_div) {
                    this.$element.css({"border-radius": a + "px"});
                    this.$border_div.css({"border-radius": a + "px"})
                } else {
                    this.$element.css({"border-radius": a + "px"})
                }
                this.$image.css({"border-radius": a + "px"});
                if (this.parent_this.options.hv_switch) {
                    if (this.options.activate_border_div) {
                    ...
                    this.$image.animate({width: i, height: r}, t, this.options.arrow_easing, u);
                    if (typeof this.parent_this.default_circle_top == "undefined")this.parent_this.default_circle_top = n - c;
                    if (this.parent_this.have_text_label_up) {
                    ...
                    if (this.parent_this.have_text_label) {
                        ...
                        if (b > 0)w = y / 2 - b / 2;
                        if (this.parent_this.have_text_label_up)this.$upper_text_span.animate({top: g + "px"}, t, this.options.moving_easing);
                        if (this.parent_this.have_text_label_down)this.$lower_text_span.css({top: w + "px"})
                    }
                } else {
                    if (this.options.activate_border_div) {
                    ...
                    this.$image.animate({width: r, height: i}, t, this.options.arrow_easing, u);
                    if (this.parent_this.have_text_label)f = r - (r - this.options.small_pic_width) / 2 - this.options.small_pic_width;
                    if (this.parent_this.have_text_label_up) {
                        this.$upper_text.animate({
                            left: e + f,
            ...
            e.preventDefault();
            if (this.options.hv_switch)var t = e.pageY - this.parent_this.y_offset - this.options.circle_left_offset; else var t = e.pageX - this.parent_this.x_offset + this.parent_this.minus - this.options.circle_left_offset;
            ...
            if (this.parent_this.mouse_moved == 0) {
                ...
                if (this.options.activate_border_div) {
                    this.$border_div.css({width: this.element_width + 2 + "px", height: this.element_height + 2 + "px"})
                }
    ...
    content_slider.prototype = {
        $: function (e) {
            ...
            if (e.substr(0, n) == this.id) {
                ...
                if (i) {
                    $("html, body").animate({scrollTop: this.$element.offset().top - 40}, 1e3)
                }
                if (r > -1) {
            ...
            if (this.options.hv_switch) {
                ...
                if (this.options.wrapper_text_max_height + 13 >= e) {
                    ...
                    if (this.under_600 == 1) {
                        if (this.options.vert_text_mode == 1)this.max_size = Math.floor(this.options.big_pic_width / 2); else this.max_size = this.options.child_div_width
                    }
            ...
            var r = 0;
            if (this.options.max_shown_items > 1 && this.options.hv_switch == 0) {
                if (this.options.border_on_off == 1)r = 8; else r = 11
            }
            this.slider_text.css({width: t - this.options.left_text_class_padding - e - r + "px"});
            if (this.minus > 0) {
            ...
            var e, t, n;
            var r = '<div class="' + this.options.container_class + '"><div class="image_more_info"><a href="#"><img alt="" src="' + this.options.plugin_url + '/more.png"></a></div>';
            this._start = -1;
            ...
            if (this.options.hv_switch)r += '<div class="clear"></div></div>'; else r += "</div>";
            ...
            this.$container.on("touchmove", $.proxy(function (e) {
                ...
                while (1) {
                    ...
                    var s = 0;
                    if (t.clientX > 0 && t.clientY > 0)s = 1; else break;
                ...
                if (r < $(this.$container).width() && r > 0 && i < $(this.$container).height() && i > 0)this._mouse_move(t); else this._mouse_leave(t)
            }, this))
            ...
            var s;
            if (this.options.hide_content == 0)s = r.height(); else s = 0;
            ...
            if (e) {
                if (!this.options.hv_switch) {
                    if (t != 0) {
                        this.$parent_wrapper.css({width: t + "px"});
            ...
            if (this.options.hv_switch) {
                this.$container.css({height: n.new_pos + "px", width: this.ret_values.height + "px"});
                this.$element.css({height: n.new_pos2 + "px", width: this.options.wrapper_text_max_height + "px"})
            } else {
                this.$container.css({width: n.new_pos + "px", height: this.ret_values.height + "px"});
                this.$element.css({width: n.new_pos2 + "px", height: wrapper_text_max_height + "px"});
            ...
            if (this.options.hv_switch) {
                if (this.options.border_on_off == 0 || this.options.use_thin_arrows == 1) {
                    e = '<div class="circle_slider_nav_left"><img src="' + this.options.plugin_url + '/left_vertical2.png" alt="left" /></div>';
                    e += '<div class="circle_slider_nav_right"><img src="' + this.options.plugin_url + '/right_vertical2.png" alt="right" /></div>'
                } else {
                    e = '<div class="circle_slider_nav_left"><img src="' + this.options.plugin_url + '/left_vertical.png" alt="left" /></div>';
                    e += '<div class="circle_slider_nav_right"><img src="' + this.options.plugin_url + '/right_vertical.png" alt="right" /></div>'
                }
            } else {
                if (this.options.border_on_off == 0 || this.options.use_thin_arrows == 1) {
                    e = '<div class="circle_slider_nav_left"><img src="' + this.options.plugin_url + '/left2.png" alt="left" /></div>';
                    e += '<div class="circle_slider_nav_right"><img src="' + this.options.plugin_url + '/right2.png" alt="right" /></div>'
                } else {
                    e = '<div class="circle_slider_nav_left"><img src="' + this.options.plugin_url + '/left.png" alt="left" /></div>';
                    e += '<div class="circle_slider_nav_right"><img src="' + this.options.plugin_url + '/right.png" alt="right" /></div>'
                }
            }
            return e
        }, _hide_arrows: function (e) {
            if (this.options.border_on_off == 0 || this.options.use_thin_arrows == 1)move_more = 4; else move_more = 0;
            if (e) {
            ...
            if (this.options.hv_switch) {
                ...
                this.$right_arrow.animate({top: e + "px"}, this.options.arrow_speed, this.options.arrow_easing, $.proxy(this._arrows_shown, this))
            } else {
                ...
                this.$right_arrow.animate({left: e + "px"}, this.options.arrow_speed, this.options.arrow_easing, $.proxy(this._arrows_shown, this))
            }
            this.show_text(this.math._convert_position_to_image_array(0, this.mid_elem));
            ...
            if (this.options.hv_switch) {
                this.$left_arrow_class.css({top: e.first_arrow_x, left: e.arrow_y});
                this.$right_arrow_class.css({top: e.second_arrow_x, left: e.arrow_y})
            } else {
                this.$left_arrow_class.css({left: e.first_arrow_x, top: e.arrow_y});
                this.$right_arrow_class.css({left: e.second_arrow_x, top: e.arrow_y})
            }
            ...
            if (t)$text_element.fadeOut(); else $text_element.hide()
            ...
            if (s.length)this.options.vert_text_mode = 1; else this.options.vert_text_mode = 0;
            ...
            if (t == 0)i.fadeIn();
            if (this.options.hv_switch == 0) {
                if (this.minus > 0)this._set_parent_window_size(1); else {
                    if (this.options.automatic_height_resize) {
                        this.ret_values = {height: 0, width: 0};
                        this.ret_values.height = 2 * this.options.top_offset + this.options.shadow_offset;
                        var u;
                        if (this.options.hide_content == 0)u = i.height(); else u = 0;
                        ...
                        if (f != this.last_height) {
                            ...
                            this.last_height = f;
                            this.$element.animate({height: f + "px"}, 300, "linear")
                        }
                    }
                }
            }
            if (this.options.hv_switch) {
                if (this.options.vert_text_mode) {
                    ...
                    if (l >= this.max_size || n) {
                        o.css({width: this.max_size * 2 + "px"})
                    }
                    var c = o.height();
                    if (this.under_600 == 0)i.css({top: this.mid - c - this.options.left_text_class_padding + "px"})
                } else {
                    ...
                    if ($block.length) {
                        ...
                        if (this.under_600 == 0) {
                            ...
                            if (p > this.options.wrapper_text_max_height)h = this.options.wrapper_text_max_height - this.container_height - 2; else h = p - this.container_height - 20
                    ...
                    if (d < 0)d = 0;
                    if (this.under_600 == 0)i.css({top: d + "px"})
                }
            } else {
                if (this.minus > 0) {
            ...
            for (i = 0; i < this.max_show; i++) {
                ...
                if (e)r = this.math._calculate_method_for_child_by_n(i, t); else r = 0;
                if (this.options.keep_on_top_middle_circle)s[i] = {i: i, pos: n.new_pos};
            ...
            if (typeof e != "undefined")if (typeof e.pageX != "undefined") {
                if (this.options.hv_switch)var n = e.pageY - this.offset - this.options.circle_left_offset; else var n = e.pageX - this.offset + this.minus - this.options.circle_left_offset
            }
            ...
            if (this.show_mouse_move) {
                ...
                if (Math.abs(this.math.sum_movement) == 0 && !this.was_gone && n == 0) {
                    this.func = 0;
                    t = 0;
                    if (this.options.hv_switch)var r = this.math._change_master_position_by_x(e.pageY - this.offset - this.options.circle_left_offset); else var r = this.math._change_master_position_by_x(e.pageX - this.offset + this.minus - this.options.circle_left_offset);
                    this.last_c = r;
                    ...
                    if (r.pos < 0) {
                        this.click = 2;
                        if (r.pos < -1)this.operation = 1; else this.operation = 0;
                        this.func = this.go_right;
                        this._hide_arrows(1)
                    }
                    if (r.pos > 0) {
            ...
            var r, i;
            if (typeof e != "undefined")if (typeof e.pageX != "undefined") {
                if (this.options.hv_switch)r = e.pageY - this.offset - this.options.circle_left_offset; else r = e.pageX - this.offset + this.minus - this.options.circle_left_offset;
            ...
            var e;
            if (this.do_animate)e = this.max_show + (this.max_show - 3); else e = this.max_show + (this.max_show - 2);
            ...
            if (this.options.auto_play_direction == 1)this.timeout_autoplay_handler = setInterval(function () {
                e.public_go_left(1)
            }, e.options.auto_play_pause_time); else this.timeout_autoplay_handler = setInterval(function () {
                e.public_go_right(1)
    ...
    position.prototype = {
        _convert_n_to_position: function (e) {
            ...
            if (e <= t) {
                ...
                r = this.mid_elem - r;
                return {pos: -r, master_click: 0}
            }
            if (e < n) {
                return {pos: 0, master_click: 1, dist_left: e - t, dist_right: n - e}
            }
            ...
            return {width: t, height: n, margin_left: r, margin_top: i}
            ...
            return {first_arrow_x: t, second_arrow_x: i, arrow_y: r}
    ...
    $.fn.content_slider = function (e, t) {
        var n = $(this), r = n.data("tooltip"), i = typeof e == "object" && e;
        r || n.data("tooltip", r = new content_slider(this, i));
        if (typeof t !== "undefined")return r[e](t); else {
            if (typeof e == "string") {
                return r[e]()
            }
        }
