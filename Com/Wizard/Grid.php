                            ...
                            <div class="paginations">
                                <div class="componente">
                                    <div class="form-group form-group-sm">
                                        <select class="form-control" name="gridPage" id="gridPage" onchange="$('#gridForm').submit();">
                                            <?PHP
                                            for ($intCounter = 0; $intCounter < $intPages; $intCounter++) {
                                                ?>
                                                <option value="<?PHP echo $intCounter; ?>" <?PHP echo ($intCounter == get('gridPage') ? 'selected' : ''); ?>>P&aacute;gina <?PHP echo ($intCounter + 1) . " de " . $intPages; ?></option>
                                                <?PHP
                                            }
                                            ?>
                                        </select>
    ...
    private function getActions($id, $lan = "") {
        ...
        <div class="btn-group btn-group-sm">
            ...
            foreach ($this->lstActions as $lstIcon) {
                ...
                ?> title="<?PHP echo $lstIcon['label']; ?>" alt="<?PHP echo $lstIcon['label']; ?>" class="btn btn-default"><span class="<?PHP echo $lstIcon['image']; ?>"></span></a>
                    <?PHP
                }
                ?>
        </div>
